      ...
      <div className="space-y-8">
        ...
        >
          <div 
            ...
            style={{ 
              backgroundImage: 'url("/images/cropped/img.jpg")',
              backgroundPosition: '50% 60%', /* Adjusted to show more of the complete image */
              backgroundSize: 'cover',
              transform: 'scale(1.2)', /* Reduced scale to show more of the image */
            }}
          />
